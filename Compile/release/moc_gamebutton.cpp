...
#include "../../FlowGame/ViewComponent/gamebutton.h"
...
QT_MOC_LITERAL(3, 20, 11) // "GameButton*"

    },
    "GameButton\0Clicked\0\0GameButton*"
};
...
void GameButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->Clicked((*reinterpret_cast< GameButton*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (GameButton::*_t)(GameButton * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameButton::Clicked)) {
                *result = 1;
            }
        }
...
// SIGNAL 1
void GameButton::Clicked(GameButton * _t1)
{

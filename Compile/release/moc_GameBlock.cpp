...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameBlock_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GameBlock_t qt_meta_stringdata_GameBlock = {
    {
QT_MOC_LITERAL(0, 0, 9) // "GameBlock"
...
const QMetaObject GameBlock::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GameBlock.data,
      qt_meta_data_GameBlock,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GameBlock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameBlock.stringdata0))
        return static_cast<void*>(const_cast< GameBlock*>(this));
